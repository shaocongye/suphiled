...
- (id)init {
    ...
    if (self) {
        ...
        self.widthOfEachNo = 20;
        self.heightOfEachNo = 20;
...
-(void)createSliderView
{
    ...
    sliderView.layer.borderWidth = 0.0f;
...
-(void)drawRatingView
{
    ...
    float itemY = 0;
    int differ = (int)self.minimumRating;
    //creating items
    itemsAry = [NSMutableArray new];
    itemsXPositionAry = [NSMutableArray new];
    for (int i =(int)self.minimumRating; i<(int)self.maximumRating+1; i = i+(int)self.difference) {
        ...
        differ = differ + (int)self.difference;
