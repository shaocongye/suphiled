...
- (NSAttributedString *)pickerView:(UIPickerView *)pickerView attributedTitleForRow:(NSInteger)row forComponent:(NSInteger)component {
    ...
    switch (component) {
        case DayPicker:
            ...
            break;
        case HourPicker:
            title = [NSString stringWithFormat:@"%02ld", (int)(row % [self realNumberOfRowsInComponent:component])];
            [paragraphStyle setAlignment:NSTextAlignmentCenter];

            break;
        case MinutePicker:
            title = [NSString stringWithFormat:@"%02lu", (int)row % [self realNumberOfRowsInComponent:component] * self.minuteStep];
