...
@protocol DeviceTableViewDataSource <NSObject>
@required
...
@protocol DeviceTableViewDelegate <NSObject>
@optional
...
@property (weak,nonatomic) id <DeviceTableViewDelegate> viewDelegate;
@property (weak,nonatomic) id <DeviceTableViewDataSource> viewDataSource;
